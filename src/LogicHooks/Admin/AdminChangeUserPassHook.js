...
import { adminUpdateUserPassAction } from '../../redux/actions/AdminUseres/AdminUseresAction';

export default function AdminChangeUserPassHook(id) {
    ...
    const res=useSelector(state=> state.adminUseresReducer.adminUpdateUserPass);
    ...
    const onSubmit=async (e)=>{
        ...
        setLoad(true);
       await dispatch(adminUpdateUserPassAction(id,{
